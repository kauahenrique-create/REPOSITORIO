...
async function buscarAnimes(termo, tentativa = 1) {
  ...
  try {
    ...
    // A AniList pode devolver status 200 com um array "errors" dentro do JSON
...
function abrirModal(indice) {
  ...
  const sinopse = anime.description || "Sinopse não disponível para este título.";
  ...
  modalConteudo.innerHTML = `
    <div class="modal-grid">
      ...
      <div>
        ...
        <p class="modal-synopsis">${sinopse}</p>
      </div>
    </div>
  `;
